  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: "We'll notify you when FX Bot launches.",
      });
            ...
            {isSuccess ? (
              ...
              <div className="text-center py-8 animate-fade-in">
                ...
                <p className="text-muted-foreground mb-6">
                  We'll send you an email as soon as FX Bot is ready to use.
                </p>
                <Link to="/">
              ...
              <>
                <div className="text-center mb-8">
                  ...
                  <p className="text-muted-foreground">
                    Be the first to know when FX Bot launches. We'll send you an exclusive invitation.
                  </p>
                </div>
