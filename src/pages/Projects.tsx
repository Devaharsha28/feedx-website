...
const Projects = () => {
  const [expandedProjectId, setExpandedProjectId] = useState<string | null>('fxbot');
    ...
    () => [
      {
        id: 'fxbot',
        title: 'FX Bot',
        subtitle: 'Anonymous student feedback platform',
        category: 'Student Feedback',
        status: 'Pilot',
        description:
          'An anonymous feedback platform where students can share issues and suggestions and track follow-ups using a reference ID.',
        details: [
          'Anonymous feedback and issue reporting',
          'Reference ID for tracking updates',
          'Simple, mobile-first submission flow',
          'Planned WhatsApp-first submission option',
        ],
      },
    ],
    []
                  ...
                  <div className="flex items-start justify-between gap-3">
                    <div className="flex items-center gap-3">
                      <div className="h-11 w-11 rounded-xl bg-muted flex items-center justify-center flex-shrink-0">
                        <img src={fxbotIcon} alt="FX Bot icon" className="h-7 w-7" loading="eager" decoding="async" />
                      </div>
                      <div>
                ...
                <CardContent className="pt-0">
                  ...
                  {isExpanded && (
                    <div className="mt-5 rounded-2xl bg-muted/40 p-4">
                      <h4 className="font-semibold mb-2">FX Bot — Details</h4>
