            ...
            <div className="overflow-y-auto w-full">
              ...
              <div className="flex flex-col items-center text-center p-6">
                ...
                <button
                  ...
                  className="w-full sm:w-auto px-10 py-2 rounded-full bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white font-medium shadow-md transition-all transform hover:scale-105"
                >
